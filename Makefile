...
C_SRCS += Object.c
C_SRCS += TestLib.c
C_SRCS += DE1_SOC_graphics.c
C_SRCS += DE1_SOC_touchscreen.c
C_SRCS += Bounds.c
C_SRCS += Button.c
C_SRCS += DrawOperations.c
C_SRCS += ListView.c
C_SRCS += ProgressBar.c
C_SRCS += Renderer.c
C_SRCS += ScreenView.c
C_SRCS += Shapes.c
C_SRCS += View.c
C_SRCS += Event.c
C_SRCS += EventHandler.c
C_SRCS += TouchEventHandler.c
CXX_SRCS :=
ASM_SRCS :=
